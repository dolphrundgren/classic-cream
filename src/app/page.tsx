...
export default function Home() {
  ...
  return (
    <>
      <div
        className={`sticky top-0 p-4 w-full h-[100px] transition-bg ease-in-out ${isMenuOpen ? "bg-red-50" : "bg-blue-50"} flex items-center justify-between isMenuOpen:bg-blue-50`}
      >
        <Image
    ...
    duration-300
    ${isMenuOpen ? "h-[calc(100vh-100px)] z-50 opacity-100 bg-red-50" : "bg-blue-50 h-0 -translate-y-10 opacity-0 z-0"}`}
      >
        <ul
