...
const PageClient = (props: any) => {
  ...
  const premiumBadge = pageData.layout[3].media.sizes.medium.url
  return (
  ...
  self-center flex flex-col lg:flex-row items-center justify-center
  ...
  h-[650px] w-[440px] self-end z-40"
          ...
          <RichText
            className="w-2/5 text-xs md:text-xl lg:text-2xl xl:text-xl"
