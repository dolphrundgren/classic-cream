  ...
  return (
    <header className="container h-48 relative z-20">
      <div className="py-8 flex flex-row lg:justify-start gap-4 justify-center">
        ...
        <nav className="hidden lg:flex flex-row self-center gap-4 text-2xl font-bold">
        ...
        <img
          ...
          height={181}
          decoding="async"
          className="h-[130px] hidden lg:block"
          src="/api/media/file/Finest_Ingredients.svg"
        />
      </div>
      <div className="hidden lg:block absolute right-0 top-0 m-auto overflow-visible h-[250px] w-[400px]">
        <Image
